...
<body>
    ...
    <!-- sản phẩm mainboard -->
    <div class="VGA bg-white">
        <h2 class="mt-4" style="text-align: center; color: #0099ff;">
            <a id="vga"> VGA</a>
        </h2>
        ...
        <div class="container">
            <div class="row g-3 mt-4">
                @foreach($vga as $product)
                <div class="col-12 col-sm-6 col-md-4 col-lg-3 mb-4">

                    <div class="card"> </a>
                        <a href="{{ route('productVga_detail', $product->id) }}"><img src="{{ asset($product->image) }}" class="card-img-top" alt="{{ $product->name }}"></a>
                        <div class="card-body">
                            <a style="text-decoration: none; color:inherit" href="{{ route('productVga_detail', $product->id) }}">
