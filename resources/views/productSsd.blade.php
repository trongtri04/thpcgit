        ...
        <form action="/cart/add" method="post">
            <div class="container">
                <div class="row g-3 mt-4">
                    @foreach($ssd as $product)
                    <div class="col-12 col-sm-6 col-md-4 col-lg-3 mb-4">
                        <div class="card">
                            <a href="{{ route('productSsd_detail', $product->id) }}"><img src="{{ asset($product->image) }}" class="card-img-top" alt="{{ $product->name }}"></a>
                            <div class="card-body">
                                <a style="text-decoration: none; color:inherit" href="{{ route('productSsd_detail', $product->id) }}">
