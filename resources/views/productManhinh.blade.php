...
<body>
    ...
    <!-- sản phẩm mainboard -->
    <div class="manhinh">
        <h2 class="mt-4" style="text-align: center; color: #0099ff; font-weight:bold ;">
            <a id="manhinh"> Màn Hình</a>
        </h2>
        <div class="mt-4" style="width: 200px; margin: 0 auto; border-bottom: 1px solid; margin-top: 20px;"></div>
        <div class="container">
            <div class="row g-3 mt-4">
                @foreach($manhinh as $product)
                <div class="col-12 col-sm-6 col-md-4 col-lg-3 mb-4">
                    <div class="card">
                        <a href="{{ route('productManhinh_detail', $product->id) }}"><img src="{{ asset($product->image) }}" class="card-img-top" alt="{{ $product->name }}"></a>
                        <div class="card-body">
                            <a style="text-decoration: none; color:inherit" href="{{ route('productManhinh_detail', $product->id) }}">
