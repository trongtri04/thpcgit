    ...
    <div class="CPU mt-4">
        ...
        <div class="container mt-4">
            <div class="row g-3 mt-4">
                @foreach($cpu as $product)
                <div class="col-12 col-sm-6 col-md-4 col-lg-3 mb-4">
                    <div class="card">
                        <a href="{{ route('productCpu_detail', $product->id) }}"> <img src="{{ asset($product->image) }}" class="card-img-top" alt="{{ $product->name }}"></a>
                        <div class="card-body">
                            <a style="text-decoration: none; color:inherit" href="{{ route('productCpu_detail', $product->id) }}">
